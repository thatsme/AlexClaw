...
| Command | Description |
|---|---|
| `/confirm 2fa <code>` | Confirm a set-up started in the admin UI |
...
`/setup 2fa` and `/disable 2fa` on a gateway are refused and answer where to do
it; the secret never travels over a chat.
